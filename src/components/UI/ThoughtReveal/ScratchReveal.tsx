  ...
  return (
    ...
    >
     ...
     transition-opacity duration-1000 pointer-events-none
      ...
      {/* yellow glow */}
      <svg
        className={`absolute w-full h-auto scale-108 top-[-2.5%] left-[0%] transition-opacity duration-1000 ${isRevealed ? "opacity-0 animate-none" : "opacity-100 animate-pulse-fast"}`}
        width="508"
        height="366"
        viewBox="0 0 508 366"
        fill="none"
      ...
      {/* inner glow */}
      <svg
        className={`absolute w-full h-auto scale-108 top-[-2.3%] left-[0%] transition-opacity duration-1000 ${isRevealed ? "opacity-0" : "opacity-100"}`}
        width="760"
        height="542"
        viewBox="0 0 760 542"
        fill="none"
