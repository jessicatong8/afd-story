...
const Touch28 = ({ clicked, hover }: Props) => {
  return (
    <span>
      <svg
        className={`absolute w-1/2 h-1/2 scale-103 top-[66.8%] left-[32%] -translate-x-[50%] -translate-y-[50%] transition-opacity duration-1000
      ...
      <img
        src={text}
        className={`absolute w-1/2 scale-110 h-auto top-[65.4%] left-[35.8%] -translate-x-[50%] -translate-y-[50%] transition-opacity duration-300
