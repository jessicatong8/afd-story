...
const Words20 = ({ clicked, hover }: Props) => {
  return (
    <span>
      <svg
        className={`absolute w-1/2 h-1/2 scale-114 top-[60.5%] left-[36.2%] -translate-x-[50%] -translate-y-[50%] transition-opacity duration-1000
      ...
      <img
        src={text}
        className={`absolute w-1/2 scale-100 h-auto top-[58%] left-[35.5%] -translate-x-[50%] -translate-y-[50%] transition-opacity duration-300
